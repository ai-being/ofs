...
# sender_address = 'thamaraikani69@gmail.com'
...
# CLIENT_SECRET_FILE = join(dirname(realpath(__file__)),'credentials.json')
...
#         credential_path = os.path.join(credential_dir,'microsoft_chatbot.json')
...
# A=Gmail()
# A.get_credentials()
# A.send_mail('thamaraikani69@gmal.com', 'subject', 'body')
# #----------------------------------------------
